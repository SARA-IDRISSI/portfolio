    ...
    return (
        <div className="presentation  bg-white" data-aos="zoom-in-up" id="présentation">
            <div className="presen container">
                ...
                <p>Je suis IDRISSI SARA, aprés l'obtention de mon diplôme en <strong>développent informatique</strong>  et l'experience que j'ai acquise j'ai décidé de rejoindre l'ecole 3W Academy por apportez la valeur ajoutée que vous recherchez ,  sachant que je passionné par <strong>le Developpement web</strong> et je me basé par ma patience mon calme et ma résilience. J'ai créé ce site pour que vous puissiez me connaître personnellement à travers mes projets. Aujourd’hui <strong>je suis à la recherche de nouvelles opportunités</strong>.</p>
